...
1. Maven 3.5
2. Tomcat 8.5
3. Database is vendor independent (Change the JDBC URL, Hibernate dialect, JDBC Driver based the Database vendor in [dataaccess.properties](https://github.com/srkrissh/jsf-spring-hibernate/blob/master/customer-order/src/main/resources/dataaccess.properties))
